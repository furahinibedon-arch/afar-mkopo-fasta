...
const S=z.object({
  ...
  loanAmountWords:z.string().min(1,"Required"),dailyPayment:z.number().optional(),
...
export default function BorrowerPortal(){
  ...
  const{register,handleSubmit,watch,trigger,formState:{errors}}=useForm<FD>({resolver:zodResolver(S),defaultValues:{loanAmount:0,loanAmountWords:""}});

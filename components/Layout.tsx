      ...
      <header className={`fixed inset-x-0 top-0 z-50 transition-all duration-300 ${scrolled?"bg-white/95 backdrop-blur shadow-md":"bg-white border-b border-slate-100"}`}>
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-16 flex items-center justify-between">
          ...
          <div className="flex items-center gap-2">
            ...
            {!isPublic&&portal==="admin"&&<nav className="hidden md:flex gap-1 mr-2"><NL href="/admin" label="Dashboard" p={pathname} exact/><NL href="/admin/loans" label="Loans" p={pathname}/></nav>}
